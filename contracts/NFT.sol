...
contract NFT is ERC1155, Ownable, ERC1155Supply {
    ...
    OrganizationNFT public _organizationNFT;
    ...
    constructor(string memory uri, PathToken pathToken, OrganizationNFT orgNFT) ERC1155(uri) {
        _pathToken = pathToken;
        _organizationNFT = orgNFT;
    }
    ...
    function mint(uint256 id, uint256 amount) external payable projectExists(id) {
        ...
        _pathToken.mint(msg.sender, msg.value/100);
