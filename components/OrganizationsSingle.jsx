                ...
                <div className="container px-4 mx-auto">
                    <div className="flex flex-wrap -mx-4">
                        <div className="w-full lg:w-1/2 px-4 mb-5 lg:mb-0">
                            ...
                            <h5 className="text-gray-900 text-xl py-5 font-medium mb-2">{organization[0].name} from {organization[0].country}</h5>
                            <h5 className="text-gray-900 text-xl font-medium mb-2">Website: {organization[0].website}</h5>
                            <h5 className="text-gray-900 text-xl font-medium mb-2">Organization Wallet ID: {organization[0].wallet_address}</h5>
                            <div className="mb-5">
                                <h5 className="text-gray-900 text-xl font-medium mb-2">About {organization[0].name}</h5>
