                ...
                <div className="container px-4 mx-auto">
                    <div className="flex flex-wrap -mx-4">
                        <div className="w-full lg:w-1/2 px-4 mb-5 lg:mb-0">
                            ...
                            <div className="mb-5">
                                <h5 className="text-gray-900 text-xl font-medium mb-2">About Our Organization</h5>
                                <p className="text-gray-700 text-base mb-2"> {organization[0].other_info} </p>
                                <p className="text-gray-700 text-base mb-2">Our Website: {organization[0].website}</p>
                            </div>
                        </div>
